...
Regenerate the primary paper plots from frozen results:
...
The matched-availability frontier is generated by
`python3 exp/matched_availability.py` (also run by `make rq1`); `make figures`
alone leaves its committed copy unchanged.
